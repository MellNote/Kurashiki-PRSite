...
//cssコピー(vendors)
const csscopy = () => {
    return src("styles/vendors/*.css").pipe(dest("dist/css/"));
};
...
const watchFiles = () => {
    ...
    watch(srcPath.html, series(csscopy, browserSyncReload));
...
exports.default = series(series(htmlcopy, csscopy, cssSass, jsBabel, imgImagemin), parallel(watchFiles, browserSyncFunc));
